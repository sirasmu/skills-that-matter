...
* C - I just really like C. I honestly don't really feel attracted to object oriented languages after I started working with C. There is minimal magic going on behind the scenes. It is just sort of beautiful and does not seem bloated.
...
uages so that they can form their mental model around that concept, but I am not sure that I actually would like to stay within the object oriented world. I should probably still become more well aquinted with C++. 
...
"This is what I am sure of, and this is what I think of this, but I didn't look into the details".

Instead of:

"Ehh I think it works this way, but it could also kind of be this way. I am no really sure. Can I please go?"

I think it is important to accept that my experience and views are valid. That it is OK that I am properly not ever going to be someone who can just keep talking for a long time that interests me. I am formulating it like this because the people I have spend the most time with in my life has often been someone who would be able to talk about their favourite topic for hours without much input. I used to want to be able to communicate in this way as well, because I often thought that they said something interesting and I had some admiration for the passion. However, knowing some of these people for over a decade I have concluded with myself that this is actually not such an admirable skill. A few of these people will keep talking about the same thing over and over. At some point it just becomes somewhat uninteresting and you feel yourself left out of the conversation. I still desire to be able to talk about a topic at length, but I have come to accept that this intense way of talking about ones interests is probably never something I will do. And that is fine. It is fine that I communicate in a bit more short and concise way. It is more important that I feel more sure of myself instead of being wavering. I am able to have a decent ping-pong conversation as long as *I* believe and *they* believe that I have something worth sharing (vice versa).
